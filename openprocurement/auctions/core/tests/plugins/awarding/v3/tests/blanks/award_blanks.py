...
def patch_auction_award_participant_disqualification(self):
    ...
    url = '/auctions/{}/awards/{}?acc_token={}'.format(self.auction_id, self.first_award_id, self.auction_token, self.auction_token)
    ...
    url = '/auctions/{}/contracts/{}/documents?acc_token={}'.format(self.auction_id,
    ...
    url = '/auctions/{}/contracts/{}?acc_token={}'.format(self.auction_id, contract['id'], self.auction_token)
    response = self.app.patch_json(url, json_data)
    self.assertEqual(response.status, '200 OK')
    # try participant_disqualification
    url = '/auctions/{}/awards/{}?acc_token={}'.format(self.auction_id, self.first_award_id, self.auction_token)
    json_data = {
        'data': {
            'status': 'unsuccessful',
...
def invalid_patch_auction_award(self):
    response = self.app.patch_json('/auctions/{}/awards/{}?acc_token={}'.format(self.auction_id, self.first_award_id, self.auction_token),
