...
@opresource(
    ...
    collection_path='/auctions/{auction_id}/contracts/{contract_id}/prolongation',
    path='/auctions/{auction_id}/contracts/{contract_id}/prolongation/{prolongation_id}',
