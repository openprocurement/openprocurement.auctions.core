...
from openprocurement.auctions.core.plugins.awarding.v2_1.validators import (
    validate_complaint_create,
    validate_complaint_patch
)

@opresource(
    name='awarding_2_1:Auction Award Complaints',
...
class AuctionAwardComplaintResource(APIResource):
    ...
    @json_view(content_type="application/json", permission='nobody', validators=(validate_complaint_data, validate_complaint_create))
    ...
    @json_view(content_type="application/json", permission='edit_complaint', validators=(validate_patch_complaint_data, validate_complaint_patch))
    def patch(self):
