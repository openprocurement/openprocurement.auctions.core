...
from openprocurement.auctions.core.plugins.awarding.v2_1.validators import (
    validate_complaint_document_update,
    validate_complaint_document_create
)

@opresource(
    name='awarding_2_1:Auction Award Complaint Documents',
...
class AuctionAwardComplaintDocumentResource(APIResource):
    ...
    @json_view(permission='edit_complaint', validators=(validate_file_upload, validate_complaint_document_create))
    ...
    @json_view(validators=(validate_file_update, validate_complaint_document_update), permission='edit_complaint')
    def put(self):
    ...
    @json_view(content_type="application/json", validators=(validate_patch_document_data, validate_complaint_document_update), permission='edit_complaint')
    def patch(self):
        """Auction Award Complaint Document Update"""
