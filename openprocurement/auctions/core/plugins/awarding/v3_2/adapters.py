...
class AwardingV3_2ConfiguratorMixin(BaseAwardingMixin):
...
class AwardingNextCheckV3_2(AuctionAwardingNextCheckAdapter):
    """Use next_check_awarding from V3 awarding"""
    def add_awarding_checks(self, auction):
        return next_check_awarding(auction)


class AwardManagerV3_2Adapter(BaseAwardManagerAdapter):

    name = 'Award v-3_2 adapter'
